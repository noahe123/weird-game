...
namespace Rope
{
    public class RopeController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            var position = GameObject.Find("Mouse Object").transform.position;
            ...
            fragments[0].GetComponent<Rigidbody>().AddComponent<FollowTarget>().targetTransform = GameObject.Find("Mouse Object").transform;
            fragments[0].GetComponent<Rigidbody>().GetComponent<FollowTarget>().targetOffset = targetOffset;
            fragments[fragmentCount - 1].GetComponent<Rigidbody>().AddComponent<FollowTarget>().targetTransform = targetTransform;
        }
